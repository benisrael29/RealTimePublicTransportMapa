...
function pickColumnIndex(header, predicate) {
...
async function fetchGeoJsonPage(params) {
...
async function main() {
    ...
    for (const f of sa1.features) {
        ...
        if (!sa1Code || !areaSqkm || areaSqkm <= 0)
            continue;
